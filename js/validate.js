    ...
    var GetinTouch = {
                ...
                if ($(this).is('input')){
                    ...
                    if ($(this).attr('name') === "phone") {
                        if ($(this).val().length < 7 || thisInput==="" || !rv_phone.test(thisInput.val())){
                            var rvphone = true;
                            formValid = false;
                            thisInput.addClass('wrong-form');   /*inputGroup.addClass('wrong-form');*/
                            thisInput.val("");
        ...
        sendForm: function(thisForm) {
                ...
                $.ajax({
                    ...
                    success: function(){
                        //$('.popup-thanks-btn').click(function(event) {
                        //    event.preventDefault(); 
                            $('.popup-thanks').bPopup();
                        //});

                        // $("#bpopup-thanks").bPopup();
                        // $(".close-popup").click(function () {
                        //     $('#bpopup-thanks').bPopup().close();
                        //     $("#subscribe").bPopup().close();
                        //     $("#remove-metal").bPopup().close();
